...
if __name__ == '__main__':
    # 请确保文件名和你上传的文件名一致
    input_file = './corpus/ChineseCorpus199801.txt' 
    output_file = './corpus_cleaned/sample_corpus.txt'
    
    try:
        clean_corpus(input_file, output_file)
    except UnicodeDecodeError:
        # 如果utf-8报错，尝试gbk（windows下常见的编码问题）
        print("UTF-8读取失败，尝试使用GBK编码读取...")
        clean_corpus(input_file, output_file, encoding='gbk')